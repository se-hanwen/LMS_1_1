...
var AddActivitiesWithModulIdComponent = /** @class */ (function () {
    ...
    AddActivitiesWithModulIdComponent.prototype.Create = function (theForm) {
        var _this = this;
        this.errorMessage = "";
        if (this.Activity.startDate.valueOf() < this.Modulestartdate.valueOf()) {
            this.errorMessage = this.errorMessage + "Start date on activity may not be before module start date (" + this.coursestartdate + ")";
        }
        if (this.Activity.endDate.valueOf() < this.Modulestartdate.valueOf()) {
            this.errorMessage = this.errorMessage + "End date on activity may not be before module start date (" + this.coursestartdate + ")";
        }
        if (this.Activity.startDate.valueOf() > this.Moduleenddate.valueOf()) {
            this.errorMessage = this.errorMessage + "Start date on activity may not be after module end date (" + this.coursestartdate + ")";
        }
        if (this.Activity.endDate.valueOf() > this.Moduleenddate.valueOf()) {
            this.errorMessage = this.errorMessage + "End date on activity may not be after module end date (" + this.coursestartdate + ")";
        }
